...
def parse_vista_date(date_str: str) -> str | None:
    """
...
def parse_delimited_string(
    data: str, delimiter: str = "^", line_delimiter: str = "\n"
) -> list[list[str]]:
    """
...
def parse_patient_demographics(result: str, dfn: str) -> PatientDemographics | None:
    """
    ...
    demographics = PatientDemographics(
        ...
        or (
            int(first_line[4])
            if len(first_line) > 4 and first_line[4].isdigit()
            else None
        ),
...
def parse_appointments(result: str | dict) -> list[Appointment]:
    """
...
def parse_user_info(result: str | dict, duz: str) -> Provider | None:
    """
