...
class TestMedicationTool:
    ...
    @pytest.mark.asyncio
    async def test_medication_pagination(self, sample_patient_data):
        """Test medication pagination functionality"""
        medications = sample_patient_data.medications
        ...
        assert len(medications_page) == 2
        assert total_medications == 3
