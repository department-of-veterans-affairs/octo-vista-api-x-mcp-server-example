...
from src.data.test_patients import TEST_PATIENTS, search_patients_by_name, get_patient_by_dfn
...
class PatientHandlers:
    ...
    def handle_vpr_get_patient_data_json(parameters: List[Parameter]) -> Dict[str, Any]:
        ...
        if not domains:
            domains = ["patient", "allergy", "appointment", "consult", "document", 
                      "education", "exam", "factor", "image", "immunization", 
                      "lab", "med", "order", "problem", "procedure", "surgery", 
                      "visit", "vital"]
