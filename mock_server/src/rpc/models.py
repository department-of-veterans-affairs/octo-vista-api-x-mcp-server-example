...
class Parameter(BaseModel):
    ...
    ref: Optional[str] = Field(None, description="Reference parameter")
    string: Optional[str] = Field(None, description="String parameter")
    array: Optional[List[str]] = Field(None, description="Array parameter")
    namedArray: Optional[Dict[str, str]] = Field(None, description="Named array parameter")
...
class RpcRequestX(BaseModel):
    ...
    version: Optional[float] = Field(None, description="RPC version")
    timeout: Optional[int] = Field(
        15000,
        ge=10000,
        le=60000,
        description="Timeout in milliseconds (10000-60000)"
    )
    jsonResult: Optional[bool] = Field(False, description="Return result as JSON")
...
class RpcResponseX(BaseModel):
    ...
    payload: Union[Dict[str, Any], Any] = Field(..., description="Response payload")
